...
class MyAttack(ShadowModellingAttack):
    """
    ...
    def __init__(
        self, n_estimators, features=None, use_naive=True, use_hist=True, use_corr=True, model=None, label=None
    ):
        """
        Parameters
        ----------
        ...
        ShadowModellingAttack.__init__(
            ...
            FeatureBasedSetClassifier(
                ...
                model or RandomForestClassifier(n_estimators=n_estimators),
            ),
